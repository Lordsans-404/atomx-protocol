 ...
 * 
 * Jalankan dengan:
 *   cd apps/web && bun scripts/setup-devnet.mjs
 */
...
async function main() {
  ...
  // Load IDL — path relatif dari apps/web ke root/target
  const idlPath = path.resolve(__dirname, "..", "..", "..", "target", "idl", "atomx_program.json");
  ...
  console.log("   Tempel ke CreateCommitmentModal.tsx sebagai USDT_MINT\n");
}
